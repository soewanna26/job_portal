...
class AccountController extends Controller
{
    ...
    public function processForgotPassword(Request $request)
    {
        ...
        Mail::to($request->email)->send(new RestPasswordEmail($mailData));

        return redirect()->route('account.forgotPassword')->with('success', 'Reset Password email has been sent to your account');
    }
    ...
    public function resetPassword($tokenString)
    {
        ...
        if ($token == null) {
            return redirect()->route('account.forgotPassword')->with('error', "Invalid password");
        }
